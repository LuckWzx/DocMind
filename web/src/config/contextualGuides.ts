...
export const GLOBAL_USER_GUIDE_KEY = 'docmind:new-user-guide-done:v1'
export const OPEN_NEW_USER_GUIDE_EVENT = 'docmind:open-new-user-guide'

export function openNewUserGuide() {
  window.dispatchEvent(new CustomEvent(OPEN_NEW_USER_GUIDE_EVENT))
}

export const KB_EDITOR_FOCUS_SECTION_EVENT = 'docmind:kb-editor-focus-section'
export const AGENT_EDITOR_FOCUS_SECTION_EVENT = 'docmind:agent-editor-focus-section'
...
export const CONTEXTUAL_GUIDE_TOURS: Record<ContextualGuideTourId, ContextualGuideTourConfig> = {
  kbList: {
    storageKey: 'docmind:contextual-guide-kb-list:v2',
  ...
  kbCreate: {
    storageKey: 'docmind:contextual-guide-kb-create:v3',
  ...
  tenantModels: {
    storageKey: 'docmind:contextual-guide-tenant-models:v1',
    stepI18nPrefix: 'contextualGuide.tenantModels.steps',
    openDelayMs: 500,
    steps: [],
  },
  kbDetail: {
    storageKey: 'docmind:contextual-guide-kb-detail:v1',
  ...
  chat: {
    storageKey: 'docmind:contextual-guide-chat:v1',
  ...
  agentList: {
    storageKey: 'docmind:contextual-guide-agent-list:v1',
  ...
  agentCreate: {
    storageKey: 'docmind:contextual-guide-agent-create:v1',

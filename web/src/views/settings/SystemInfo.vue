...
const troubleshootingDocsURL =
  'https://github.com/Tencent/DocMind/blob/main/docs/migration-troubleshooting.md'
...
const reportIssueURL = computed(() => {
  const base = 'https://github.com/Tencent/DocMind/issues/new'
  ...
  if (errMsg) {
    const body = [
      '### Environment',
      `- DocMind version: ${systemInfo.value?.version || 'unknown'}`,

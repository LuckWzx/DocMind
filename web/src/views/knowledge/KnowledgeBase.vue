...
const VIEW_MODE_KEY = 'docmind.kb.docs.viewMode';
...
onMounted(() => {
  ...
  window.addEventListener('docmind:open-knowledge', handleOpenKnowledgeEvent as EventListener);
});
...
onUnmounted(() => {
  ...
  window.removeEventListener('docmind:open-knowledge', handleOpenKnowledgeEvent as EventListener);
  stopMovePoll();
  if (timeout !== null) {

...
const exampleData: FAQEntryPayload[] = [
  {
    standard_question: '什么是 DocMind？',
    answers: ['DocMind 是一个智能知识库管理系统', '它支持多种知识库类型和导入方式'],
    similar_questions: ['DocMind 是什么？', '介绍一下 DocMind'],
    negative_questions: ['这不是 DocMind', '与 DocMind 无关'],
    tag_name: '产品介绍',
  },
  {

<template>
  <div class="login-layout">
    ...
    <!-- DocMind Logo - Top Left -->
    <div class="header-logo">
      <div class="logo-container">
        <svg class="logo-icon" viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
          <rect width="40" height="40" rx="8" fill="rgba(255,255,255,0.2)"/>
          <path d="M12 10h6c3 0 5 2 5 5s-2 5-5 5h-6v-10z" stroke="white" stroke-width="2" fill="none"/>
          <path d="M12 20h7c3 0 5 2 5 5s-2 5-5 5h-7v-10z" stroke="white" stroke-width="2" fill="none"/>
          <circle cx="28" cy="15" r="3" fill="white"/>
          <circle cx="28" cy="25" r="3" fill="white"/>
          <path d="M31 15h4M31 25h4" stroke="white" stroke-width="2"/>
        </svg>
    ...
    <div class="header-links">
      <a href="#" target="_blank" class="header-link" title="GitHub">
...
onMounted(async () => {
  ...
  const AUTO_SETUP_FAILED_KEY = 'docmind_auto_setup_failed'

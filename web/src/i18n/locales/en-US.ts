export default {
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'Everything starts here: upload documents, web pages or FAQs and DocMind parses and indexes them automatically. Click here to open knowledge bases.',
      },
      chat: {
  ...
  settings: {
    ...
    docmindCloud: {
      title: 'DocMind Cloud',
      description: 'Configure DocMind Cloud APPID and APPSECRET credentials. Credentials are used for model services and document parsing engine.',
      viewDocs: 'View Docs',
      unconfigured: 'Credentials not configured. Please fill in APPID and APPSECRET.',
      configured: 'Credentials configured and working.',
      expired: 'DocMind Cloud credentials expired',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'DocMind Cloud application ID',
      appIdPlaceholder: 'Enter APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'DocMind Cloud application secret',
      ...
      credentialConfigured: 'DocMindCloud credentials configured.',
      credentialExpired: 'Credentials expired. Please reconfigure.',
      credentialUnconfigured: 'DocMindCloud credentials not configured. Please set up APPID and APPSECRET first.',
      checkingStatus: 'Checking credential status...',
      goToSettings: 'Go to Settings',
      modelHintConfigured: 'DocMindCloud credentials configured. See supported models in',
      modelHintDocsLink: 'API docs',
      modelsSection: {
        title: 'Cloud Models',
        descReady: 'Register the four standard DocMind Cloud models for chat, retrieval, reranking, and vision.',
      ...
      addModelsDisplayName: {
        chat: 'DocMindCloud Chat',
        embedding: 'DocMindCloud Embedding',
        rerank: 'DocMindCloud ReRank',
        vllm: 'DocMindCloud Vision',
      },
    },
    ...
    storage: {
      ...
      pathPrefixPlaceholder: 'e.g. docmind/images',
      prefixPlaceholder: 'e.g. docmind',
  ...
  createChat: {
    title: 'Hi, I am DocMind — your knowledge, within reach',
  ...
  embedPublish: {
    ...
    webhookUrlPlaceholder: 'https://your-server.example.com/docmind/embed-events',
    webhookUrlDesc: 'Optional. DocMind POSTs message_sent / message_received events to this HTTPS endpoint.',
    webhookSecret: 'Webhook secret',
    webhookSecretPlaceholder: 'HMAC-SHA256 secret (X-DocMind-Signature header)',
...
\
  ...
  system: {
    ...
    versionDescription: 'Version of the application service (docmind-app)',
    frontendVersionLabel: 'UI Version',
    frontendVersionDescription: 'Build version of the UI (docmind-ui)',
  ...
  kbSettings: {
    ...
    parser: {
      ...
      engines: {
        ...
        docmindcloud: {
          name: 'DocMind Cloud',
          desc: 'Document parsing via DocMind Cloud',
        },
        markitdown: {
          name: 'MarkItDown',
  ...
  integrations: {
    ...
    api: {
      ...
      capabilityManageKbsHint: 'Let this key manage the full knowledge-base lifecycle: create, copy, update, and delete knowledge bases and change their initialization/configuration. Operations on existing knowledge bases (copy/update/delete) stay bounded by the selected scope; creating a new knowledge base is unrestricted (the new KB belongs to this space).',
	      ...
	      capabilityManageModelsHint: 'Manage model definitions, credentials, connectivity checks, and DocMindCloud credentials.',
      ...
      hmacSecretDesc: 'Same secret stored in DocMind; used only on your backend to sign JWTs—never send it as a request header.',
      ...
      signedRequestStep0:
        '# 0. Sign JWT on your backend (HS256, aud=docmind, sub=user id, tenant_id={tenantId}, exp<=24h)',
    ...
    chrome: {
      ...
      subtitle:
        'For self-hosted DocMind: ask questions in a sidebar, clip web pages, and save Markdown notes into your knowledge bases while you browse.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'On DocMind Desktop, set a fixed API port (e.g. 37841) in API Info so the URL stays stable across restarts.',
        },
        install: {
    ...
    claw: {
      title: 'DocMind Skill',
      subtitle:
        'Import documents and run hybrid retrieval (vector + keyword) via the DocMind REST API—for uploads, URL imports, Markdown entries, and cross-KB search.',
      ...
      steps: {
        ...
        env: {
          ...
          desc: 'Set DOCMIND_BASE_URL and DOCMIND_API_KEY in your shell or ~/.zshrc / ~/.bashrc. The example below uses your current API base URL—replace the API Key with your actual value.',
        },
        install: {
      ...
      ecosystemNote:
        'Skill hosted on ClawHub ({\'@\'}lyingbug/docmind). See the ClawHub page for full API docs and version history.',
      installCta: 'Open ClawHub',
      installCtaHint: 'Install DocMind Skill · opens in a new tab',
      hubMeta: 'ClawHub · {\'@\'}lyingbug/docmind · MIT-0',
    },
  },
  imOverview: {

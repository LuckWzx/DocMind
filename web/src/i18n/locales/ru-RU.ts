...
/example\.(net|org)/`,
  ...
  agentEditor: {
    ...
    tools: {
      ...
      kbSearchDesc: 'Агрегированный поиск: объединяет ключевой и семантический поиск с фузией и реранкингом за один вызов, возвращая наиболее релевантные фрагменты',
      ...
      webSearchDesc: 'Поиск актуальной информации в интернете (требуется настройка поисковой системы в разделе «Веб-поиск»)',
      webFetch: 'Загрузка веб-страницы',
      // Группы
      groupBase: 'Базовые',

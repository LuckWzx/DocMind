...
func NewRegistry(deps *pipeline.PipelineDeps, mcpRepo repository.MCPServiceRepository, mcpManager *mcp.Manager, webSearchSvc WebSearchService, knowledgeRepo repository.KnowledgeRepository) *Registry {
	return &Registry{
		deps:          deps,
		mcpRepo:       mcpRepo,
